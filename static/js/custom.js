...
(function($){
    ...
    * Working Contact form
    ...
    /*--------------------
        * particles
    ----------------------*/
    var $ripple_box = $('.ripple_box');
    NAY.ripple = function() {
    	if ($ripple_box.exists()) {
  			loadScript(plugin_track + 'ripples-master/jquery.ripples.js', function() {
  				$ripple_box.ripples({
					resolution: 800,
					dropRadius: 20,
					perturbance: 0.4
    ...
    NAY.mTypeIt = function() {
    	if ($("#type-it").exists()){
            loadScript(plugin_track + 'static/plugin/typeit-master/typeit.min.js', function() {
                new TypeIt('#type-it', {
		            speed: 200,
		            loop:true,
		            strings: [
